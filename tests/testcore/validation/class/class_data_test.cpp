...
TEST_CASE("ClassData::validate and ::validate_relations // valid class data", tags) {
    ClassData data;
...
TEST_CASE("ClassData::validate // invalid class data", tags) {
    ClassData data;
    set_valid_mock_values(data, "Class");
    data.hit_dice_data.str = "d6";
    data.important_levels_data.feat_levels = {4, 8, 12, 16, 19};
...
TEST_CASE("ClassData::validate_relations // invalid class data relations", tags) {
    ClassData data;
    set_valid_mock_values(data, "Class");
    data.hit_dice_data.str = "d6";
    data.important_levels_data.feat_levels = {4, 8, 12, 16, 19};
