...
inline CharacterRace::CharacterRace(const std::string& name, const bool has_subraces)
    : FeatureHolder(name), has_subraces(has_subraces) {}

inline CharacterSubrace::CharacterSubrace(const std::string& name, const std::string& race_name)
