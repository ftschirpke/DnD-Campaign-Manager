...
public:
    ...
    Creature(const std::string& name, const std::array<int, 6>& base_ability_scores) noexcept;
...
inline Creature::Creature(const std::string& name, const std::array<int, 6>& base_ability_scores) noexcept
