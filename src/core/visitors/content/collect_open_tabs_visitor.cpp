...
void dnd::CollectOpenTabsVisitor::visit(const Character* character_ptr) {
...
void dnd::CollectOpenTabsVisitor::visit(const CharacterClass* character_class_ptr) {
...
void dnd::CollectOpenTabsVisitor::visit(const CharacterSubclass* character_subclass_ptr) {
...
void dnd::CollectOpenTabsVisitor::visit(const CharacterRace* character_race_ptr) {
...
void dnd::CollectOpenTabsVisitor::visit(const CharacterSubrace* character_subrace_ptr) {
...
void dnd::CollectOpenTabsVisitor::visit(const Item* item_ptr) {
...
void dnd::CollectOpenTabsVisitor::visit(const Spell* spell_ptr) {
...
void dnd::CollectOpenTabsVisitor::visit(const Feature* feature_ptr) {
...
void dnd::CollectOpenTabsVisitor::visit(const Choosable* choosable_ptr) {
