...
dnd::Errors dnd::EffectsParser::parse(nlohmann::ordered_json&& json, dnd::EffectsData& data) const {
    Errors errors;
    if (!json.is_object()) {
    ...
    errors += parse_stat_changes(json, data.stat_changes_data, data.get_parent());
...
dnd::Errors dnd::EffectsParser::parse_activation_conditions(
...
dnd::Errors dnd::EffectsParser::parse_choices(
...
dnd::Errors dnd::EffectsParser::parse_stat_changes(
    ...
    Errors errors = parse_optional_attribute(json, "stat_changes", stat_change_strings);
...
dnd::Errors dnd::EffectsParser::parse_action_holder(nlohmann::ordered_json& json, dnd::ActionHolderData& data) const {
    Errors errors;
...
dnd::Errors dnd::EffectsParser::parse_extra_spells_holder(
...
dnd::Errors dnd::EffectsParser::parse_proficiency_holder(nlohmann::ordered_json& json, dnd::ProficiencyHolderData& data)
    const {
    Errors errors;
...
dnd::Errors dnd::EffectsParser::parse_riv_holder(nlohmann::ordered_json& json, dnd::RIVHolderData& data) const {
    Errors errors;
